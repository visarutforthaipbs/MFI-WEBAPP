...
export default function ProvinceDetailPage() {
  ...
  useEffect(() => {
    ...
    Papa.parse("/data/MFI_Results_2025_Enhanced.csv", {
      ...
      header: true,
      complete: (results) => {
        const data = results.data as MFIData[];
        const found = data.find((d) => d.Province === provinceName);
    ...
    Papa.parse(
      "/data/JUMPSTART - MFI  - [THAI]MFI Data Collection Sheet Structure.csv",
      {
        ...
        header: true,
        complete: (results) => {
          const data = results.data as RawData[];
          const found = data.find((d) => d.Province === provinceName);
          ...
          <Grid templateColumns={{ base: "1fr", lg: "1fr 1fr" }} gap={8} mb={8}>
            ...
            <VStack gap={6} align="stretch">
              <Box bg="gray.50" p={{ base: 4, md: 6 }} borderRadius="lg">
                <Heading size={{ base: "md", md: "lg" }} mb={4} color="#4C90E2">
              ...
              <Box bg="gray.50" p={{ base: 4, md: 6 }} borderRadius="lg">
                <Heading size={{ base: "sm", md: "md" }} mb={4} color="#4C90E2">
            ...
            <VStack gap={4} align="stretch">
              <Heading size={{ base: "md", md: "lg" }} color="#4C90E2">
              ...
              >
                <HStack justify="space-between" mb={3}>
                  ...
                  <Badge bg="#50E3C4" color="white" fontSize="md" px={3} py={1}>
                ...
                <VStack align="stretch" gap={2} fontSize="sm">
                  ...
                  <Box bg="gray.50" p={2} borderRadius="md" mt={2}>
                    <Text fontWeight="bold" color="#4C90E2">
              ...
              >
                <HStack justify="space-between" mb={3}>
                  ...
                  <Badge bg="#4C90E2" color="white" fontSize="md" px={3} py={1}>
